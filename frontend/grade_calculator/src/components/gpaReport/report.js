...
export default function GpaReport({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto print:shadow-none border  text-gray-300 p-4 rounded-lg overflow-hidden">
        ...
        <div className="flex flex-col gap-2 text-right">
          ...
          {gpa && (
            <div className="flex justify-end items-center gap-2">
              ...
              <span className="text-xl font-bold text-orange-500">{gpa.toFixed(1)}</span>
            </div>
          )}
